describe('Realizar login com erro ao inserir o e-mail', () => {
    it('Realizando login no Site com erro ao inserir o e-mail', () => {
      ...
      //Timer para realizar a correção do e-mail
        cy.wait(3000)

      //Seleção do campo de e-mail para correção
        cy.get('.input-container')
            .find('[type="email"]')
            .type('{selectAll}{backspace}')

      //Timer para introdução dos dados
        cy.wait(1000)

      //Introdução dos dados corretos do e-mail
        cy.get('.input-container')
            .find('[type="email"]')
      ...
      //Timer para realizar a de selecionar programas Ao Vivo
        cy.wait(3000)
